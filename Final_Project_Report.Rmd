...
* See how has the average temperature in the United States changed over 20 years.
```{r message=FALSE, warning=FALSE, echo=FALSE}
...
* See correlation between Temp and Lymn disease.
```{r message=FALSE, warning=FALSE, echo=FALSE}
...
head(new)
```
##Scatterplot showing the temperatures when the most cases occur
##Found that most cases occur at around 60 degrees
